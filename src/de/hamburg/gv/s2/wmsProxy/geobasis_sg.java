...
public class geobasis_sg extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getQueryString() != null) {
			...
			req = req.replaceAll("(LAYERS=(\\d*%2C*)*\\d?)", "LAYERS=5%2C29%2C25%2C9%2C21%2C17%2C13%2C1");
		}
		String urlS = "http://geodienste.hamburg.de/HH_WMS_Geobasisdaten_SG" + req;
				...
				if (zugriffMoeglich && connection.getResponseCode() == 200) {
					...
					if (typ.length == 2 && typ[0].equals("image")) {
						...
						while ((inputLine = br.readLine()) != null)
							response.getWriter()
									.append((inputLine.replaceAll("http://geodienste.hamburg.de/HH_WMS_Geobasisdaten_SG",
